...
"compiler2/bin/arm-none-eabi-gcc.exe" %tt1% -c "source/memory/heap.c" -o "bin/heap.o" %tt2%
"compiler2/bin/arm-none-eabi-gcc.exe" %tt1% -c "source/memory/pages.c" -o "bin/pages.o" %tt2%
